  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
      ...
      <p className="text-xs text-gray-500 mb-3">
        ...
        затем «Заполнить из Замера» — это перенесёт тип двери, открывание и размеры из замера в
        <b> пустые</b> поля позиций. Уже заполненные/исправленные вами значения <b>не затираются</b>
        (для точечной замены под замер используйте кнопку «Изменить размер двери» в позиции).
