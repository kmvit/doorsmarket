      ...
      <div className="flex items-start justify-between mb-6">
        ...
        {canEdit && (
          <div className="flex items-center gap-2">
            ...
            <Link
              to={`/orders/${order.id}/pretty-offer`}
              className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 rounded-xl transition-all"
              title="Презентационное КП для клиента: слайд на каждый проём с картинкой двери"
            >
              <svg className="h-4 w-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              to={`/orders/${order.id}/add-kp`}
              className="inline-flex items-center px-3 py-2 text-sm font-medium text-emerald-700 bg-emerald-50 hover:bg-emerald-100 rounded-xl transition-all"
              title="Прикрепить ещё одно КП: его позиции добавятся к имеющимся по категориям, ничего не удаляется"
            >
              <svg className="h-4 w-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
