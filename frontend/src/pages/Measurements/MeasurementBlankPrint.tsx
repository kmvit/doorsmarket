  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="blank-page max-w-4xl mx-auto p-8 text-[13px] text-gray-900">
        ...
        {/* Подпись сервис-менеджера — одна, в строке рядом с подписью клиента.
            Здесь стояла вторая, дублирующая: «Замер произвёл (СМ) ____».
            Тот же блок есть в PDF-бланке (orders/templates/orders/measurement_blank.html) —
            править нужно оба. */}
        <div className="border-t border-gray-300 pt-3 text-xs leading-relaxed">
          <div className="text-red-700 font-semibold">Рекомендуемые размеры проёма даны от «ЧИСТОГО» ПОЛА!!!</div>
