  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-gray-900 shrink-0">
        <span className="text-sm text-gray-300 truncate max-w-[80vw]">{fileName || 'Файл'}</span>
        <button
          onClick={onClose}
          className="ml-3 shrink-0 flex items-center gap-1.5 px-3 py-1.5 bg-white text-gray-800 text-sm font-medium rounded-lg hover:bg-gray-100 active:bg-gray-200"
          aria-label="Закрыть"
        >
